...
REM
REM Generated by Vivado on Thu Oct 23 00:41:31 -0600 2025
...
echo "xvhdl --incr --relax -prj tb_cifrador_lfsr_vhdl.prj"
call xvhdl  --incr --relax -prj tb_cifrador_lfsr_vhdl.prj -log xvhdl.log
